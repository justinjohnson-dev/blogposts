...
[^1]: Burns, B., Grant, B., Oppenheimer, D., Brewer, E., & Wilkes, J. (2016). Borg, Omega, and Kubernetes. ACM Queue, 14, 70-93. [Read more](https://dl.acm.org/doi/10.1145/2898442.2898444)

[^2]: Kubernetes.io. (n.d.). Understanding Kubernetes Objects. [Read more](https://kubernetes.io/docs/concepts/overview/working-with-objects/kubernetes-objects/)

[^3]: Kubernetes.io. (n.d.). Managing Resources. [Read more](https://kubernetes.io/docs/concepts/cluster-administration/manage-deployment/)

[^4]: Jacobs, H. (2020). Kubernetes Deployment Strategies. Container Solutions. [Read more](https://container-solutions.com/kubernetes-deployment-strategies/)

[^5]: StackRox. (n.d.). Kubernetes Monitoring Guide. [Read more](https://www.stackrox.com/post/2020/06/kubernetes-monitoring-guide/)

[^6]: The New Stack. (2023). Kubernetes: The Future of Cloud Hosting. [Read more](https://thenewstack.io/kubernetes-the-future-of-cloud-hosting/)
